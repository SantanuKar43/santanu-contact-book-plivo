...
public class ContactServiceTest {
	...
	public void testFindContactByName() {
		...
		Contact contact = new Contact(null, name, email, phone);
		Contact contact1 = new Contact(null, name, email1, phone);
		Contact contact2 = new Contact(null, name, email2, phone);
	...
	public void testUpdateContact() {
		...
		Boolean result = contactService.updateContact(email, name1, "");
		Assert.assertTrue(result);
